...
df = pd.read_csv('./Olympics_Analysis_App/Data/athlete_events.csv')
region_df = pd.read_csv('./Olympics_Analysis_App/Data/noc_regions.csv')
...
if user_menu == 'Athlete wise Analysis':
    ...
    fig1 = px.line(final, x="Year", y=["Male", "Female"])
